...
from tracking.ros2_utils import make_camera_info_msg, numpy_to_image_msg
...
class RealSensePublisherNode:
    ...
    def __init__(self, args: argparse.Namespace) -> None:
        ...
        self.rs = rs
        self.rclpy = rclpy
        self.node = _Node("realsense_publisher")
        self.pipeline = None
        self.align = None
        self.color_pub = None
        self.depth_pub = None
...
def main() -> None:
    ...
    if args.list_devices:
        try:
            ...
            print(f"Could not enumerate RealSense devices: {exc}")
            return
        if not devices:
