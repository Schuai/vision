...
from tracker.FoundationPose_plus_plus.src.VOT import Cutie, Tracker_2D  
...
def pose_track(
    ...
    # Load the mesh
    #################################################
    from tracker.FoundationPose_plus_plus.FoundationPose.estimater import trimesh_add_pure_colored_texture
    ...
    from tracker.FoundationPose_plus_plus.FoundationPose.estimater import (
        ScorePredictor,
        PoseRefinePredictor,
        dr,
        FoundationPose,
    ...
    from tracker.FoundationPose_plus_plus.FoundationPose.Utils import nvdiffrast_render
    import logging
