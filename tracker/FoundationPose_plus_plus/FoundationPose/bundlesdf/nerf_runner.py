...
sys.path.append(f'{code_dir}')
from tracker.FoundationPose_plus_plus.FoundationPose.bundlesdf.nerf_helpers import *
...
class NerfRunner:
  ...
  def mesh_texture_from_train_images(self, mesh, rgbs_raw, tex_res=1024):
    ...
    from tracker.FoundationPose_plus_plus.FoundationPose.offscreen_renderer import ModelRendererOffscreen
