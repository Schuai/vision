...
from tracker.FoundationPose_plus_plus.FoundationPose.foundationpose_wrapper import FoundationPoseWrapper
from sam2.wrapper import Sam2Wrapper
from tracker.FoundationPose_plus_plus.src.utils.kalman_filter_6d import KalmanFilter6D

from script.ros2_utils import (
    bbox_xywh_to_xyxy,
...
def ensure_foundationpose_optional_extensions(logger: Any | None = None) -> None:
    ...
    try:
        import tracker.FoundationPose_plus_plus.FoundationPose.Utils as Utils
        import torch
    except ModuleNotFoundError:
        return
    ...
    try:
        import tracker.FoundationPose_plus_plus.FoundationPose.estimater as estimater
    except ModuleNotFoundError:
        return
...
class LiveObjectPoseTrackerNode:
    ...
    def _get_pose_depth_renderer(self, camera_matrix: np.ndarray, image_shape: tuple[int, int]) -> Any | None:
        ...
        try:
            from tracker.FoundationPose_plus_plus.FoundationPose.offscreen_renderer import ModelRendererOffscreen, cvcam_in_glcam
